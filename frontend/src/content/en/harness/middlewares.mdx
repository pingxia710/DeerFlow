...
9. `LoopDetectionMiddleware` — breaks repetitive tool call loops for ordinary lead agents; excluded from the Command Room
10. Custom middlewares (if any)
...
The coordinator-only Command Room does not load this middleware. Its lead AI
decides whether another one-shot AI is useful and when the work is complete.
