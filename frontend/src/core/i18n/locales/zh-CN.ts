...
export const zhCN: Translations = {
  ...
  chats: {
    ...
    trajectory: {
      ...
      chairOutput: "指挥室更新",
      context: "信息层",
      workPackage: (id) => `工作包：${id}`,
      planning: "规划",
      technicalDesign: "技术设计",
      execution: "执行",
      review: "审查",
      evaluation: "评估",
      cycle: (label, index) => `${label} · 第 ${index} 轮`,
      deliveryCycle: (index) => `交付第 ${index} 轮`,
      cycles: (count) => `${count} 个轮次`,
      plans: (count) => `${count} 个方案`,
      tasks: (count) => `${count} 个子任务`,
      running: "运行中",
      completed: "已完成",
      failed: "失败",
      mixed: "混合状态",
      ...
      recentTasks: "最近任务",
      unnamedTask: "后台任务",
      informationDeposit: "信息沉淀",
      plan: "方案",
      planResearch: "规划研判",
      planProposal: "方案定稿",
      technicalPlan: "技术方案",
      planForming: "方案正在形成。",
      planArtifactNotWritten: "方案尚未落盘。",
      planArtifactUnavailable: "方案暂不可读取。",
      delivery: "执行与审查",
      otherProcess: "其他过程",
      previousOutputs: (count) => `此前输出（${count}）`,
      startedAt: "开始时间",
      finishedAt: "结束时间",
      elapsed: "耗时",
      recordedAt: "时间",
      resultUnavailable: "结果暂不可读取。",
    },
    workRecord: {
      title: "任务动态",
      open: "打开任务动态",
