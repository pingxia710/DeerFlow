      ...
      {!isLoading && showCopyButton && (
        <MessageToolbar
          className={cn(
            ...
            "pointer-events-none z-20 opacity-0 transition-opacity delay-200 duration-300 group-hover/conversation-message:opacity-100 focus-within:opacity-100 [@media(hover:none)]:opacity-100",
          )}
        >
          <div className="pointer-events-none flex gap-1 group-hover/conversation-message:pointer-events-auto focus-within:pointer-events-auto [@media(hover:none)]:pointer-events-auto">
            <CopyButton
              clipboardData={
