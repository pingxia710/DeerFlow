...
export const enUS: Translations = {
  ...
  agents: {
    title: "AI Team",
    description:
      "Manage model settings for persistent agents and one-shot professional roles.",
    agentsTab: "Agents",
    rolesTab: "Professional Roles",
    emptyRoles: "No configurable professional roles",
    roleCopy: {},
    newAgent: "New Agent",
    ...
    agentConfigurationDescription:
      "Choose the model and reasoning effort used by this agent on its next conversation.",
    roleConfigurationDescription:
      "Choose the model and reasoning effort used by this role on its next delegated task.",
    configurationSaved: "Configuration saved and will apply to the next run",
    delete: "Delete",
    deleteConfirm:
  ...
  chats: {
    ...
    backToTurnStart: "Back to turn start",
    commandRoomUpdate: "Command Room update",
    steps: {
      count: (count) => `Steps (${count})`,
      toggle: (count) => `Show ${count} workflow steps`,
    },
    workRecord: {
      title: "Activity",
      open: "Open activity",
      close: "Close activity",
      retry: "Refresh activity",
      loading: "Loading work record...",
      empty: "No work facts recorded yet.",
      unavailable: "Work record is unavailable right now.",
      truncated: "Earlier work facts are not in this window.",
      ...
      goalWorkspaceUnavailable: "Goal context is unavailable right now.",
      workspaceHistory: "Workspace history",
      workspaceHistoryOnDemand: "Read on demand",
      loadingWorkspaceHistory: "Loading historical facts...",
      workspaceHistoryUnavailable:
        "Workspace history is unavailable right now.",
      noWorkspaceHistory: "No matching Workspace facts.",
      loadOlderWorkspaceFacts: "Load older facts",
      loadingOlderWorkspaceFacts: "Loading older facts...",
      goalMandate: "Goal Mandate",
      operatingBrief: "Current Operating Brief",
      organizationMap: "Current Organization Map",
      noMandate: "No Goal Mandate has been recorded yet.",
      noOperatingBrief: "No Operating Brief has been recorded yet.",
      noOrganizationMap: "No Organization Map has been recorded yet.",
      ...
      goalTree: "Goal tree",
      goalTreeUnavailable: "Goal Cell relationships are unavailable right now.",
      noGoalCells: "No child Goal Cells have been created.",
      goalCell: "Goal Cell",
  ...
  subtasks: {
    ...
    artifactUnavailable: "A referenced artifact is unavailable.",
    artifactCheckFailed: "Could not load referenced artifacts.",
