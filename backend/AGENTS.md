...
- Command Room is the main development AI, not a workflow system. The user controls direction and rounds: the current goal, boundaries, and whether to continue. The lead AI is the brain; sub-AIs are hands and eyes. Within an authorized round, ordinary technical execution proceeds autonomously and users should see natural development results, while internals keep only minimal facts, memory, and boundaries.
