...
def build_pending_handoff(
    *,
    ...
    return PendingHandoff(
        ...
        evidence_strength=_clip(envelope.evidence_strength, 32),
...
def pending_handoff_from_dict(data: dict[str, Any]) -> PendingHandoff:
    ...
    envelope = HandoffEnvelope(
        ...
        evidence_strength=str(data.get("evidence_strength") or handoff_data.get("evidenceStrength") or ""),
        ...
        compact.append(
            {
                ...
                "evidence_strength": handoff.get("evidence_strength") or "",
