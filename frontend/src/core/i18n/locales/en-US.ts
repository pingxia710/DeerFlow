...
export const enUS: Translations = {
  ...
  chats: {
    ...
    trajectory: {
      title: "Tasks",
      chairOutput: "Command Room update",
      context: "Information layer",
      workPackage: (id) => `Work package: ${id}`,
      planning: "Planning",
      technicalDesign: "Technical design",
      execution: "Execution",
      review: "Review",
      evaluation: "Evaluation",
      cycle: (label, index) => `${label} · Cycle ${index}`,
      deliveryCycle: (index) => `Delivery cycle ${index}`,
      cycles: (count) => `${count} cycle${count === 1 ? "" : "s"}`,
      plans: (count) => `${count} plan${count === 1 ? "" : "s"}`,
      tasks: (count) => `${count} task${count === 1 ? "" : "s"}`,
      running: "Running",
      completed: "Completed",
      failed: "Failed",
      mixed: "Mixed",
      ...
      subtasks: "Subtasks",
      activeTasks: "Running now",
      recentTasks: "Recent tasks",
      unnamedTask: "Background task",
      informationDeposit: "Information deposit",
      plan: "Plan",
      planResearch: "Planning analysis",
      planProposal: "Plan proposal",
      technicalPlan: "Technical plan",
      planForming: "The plan is being prepared.",
      planArtifactNotWritten: "The plan has not been recorded.",
      planArtifactUnavailable: "The plan artifact is unavailable.",
      delivery: "Execution and review",
      otherProcess: "Other process",
      previousOutputs: (count) => `Previous outputs (${count})`,
      startedAt: "Started",
      finishedAt: "Finished",
      elapsed: "Elapsed",
      recordedAt: "Time",
      resultUnavailable: "Result is unavailable.",
    },
    workRecord: {
      title: "Activity",
      open: "Open activity",
